...
RUN wget -q https://repo.anaconda.com/miniconda/Miniconda3-4.3.14-Linux-x86_64.sh && \
...
RUN pip install -i https://pypi.tuna.tsinghua.edu.cn/simple matplotlib==2.1.1
