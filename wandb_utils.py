...
def init_wandb(args: Namespace):
    ...
    if 'wandb_unique_id' not in args:
        if len(args.tag) == 0:
            args.wandb_unique_id = f'{args.tag}_{args.alg}_{args.env}_{args.new}_{args.wandb_group}_{args.timestamp}'
        else:
            args.wandb_unique_id = f'{args.alg}_{args.env}_{args.new}_{args.timestamp}'
